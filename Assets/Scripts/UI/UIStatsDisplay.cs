...
public class UIStatsDisplay : MonoBehaviour
{
    ...
    public void UpdateStatFields()
    {
        ...
        //Get a reference to both text object to render stat name and stat value
        ...
        foreach (FieldInfo field in fields)
        {
            ...
            // Print it as percentage if it has an atribute is a float
            ...
            //Update the fields with the strings
            statNames.text = prettyfyNames(names);
            statValues.text = values.ToString();
        }
    }

    public static string prettyfyNames(StringBuilder input)
    {
